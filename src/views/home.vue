<template>
  ...
  <section class="w-full relative h-screen z-50 py-32 mb-32">
    <svg class="w-full absolute top-0" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
         height="100vh"
      ...
      <g transform="translate(960,440) scale(1,1) translate(-960,-440)">
        <linearGradient id="lg-0.047955344060927496" x1="0" x2="1" y1="0" y2="0">
          <stop stop-color="#3CDEDA" offset="0"></stop>
          <stop stop-color="#3CDEDA" offset="1"></stop>
        </linearGradient>
    ...
    <div class="mx-auto sm:max-w-2xl md:max-w-3xl md:px-12 lg:max-w-5xl xl:max-w-7xl xl:px-32">
      <div class="text-center">
        <div
            ...
            ">
          <h1 class="mt-6 mb-16 text-3xl md:text-5xl font-bold tracking-tight md:text-6xl xl:text-7xl">
            Événements Locaux à Votre Portée : <br/><span class="text-primary"> Créez, Découvrez et Partagez !</span>
          </h1>
          <button
              class="mb-2 inline-block rounded bg-cyan-500 px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] md:mr-2 md:mb-0"
              href="#!" role="button">
            <router-link to="/search"> Découvrez</router-link>
          </button>
          <button
